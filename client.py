...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
    ...
    MSG = encode_message(MSG) #encoding the message by adding a header with VPN/Server Ip and Port
...
print(f"Received response: '{data}' [{len(data)} bytes]") #received response from the server.
